...
public class MapOrderAndDetailRateModelFunc extends RichMapFunction<JSONObject, JSONObject> {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        connection = JdbcUtils.getMySQLConnection(
                "jdbc:mysql://cdh03:3306/flink_realtime",  // 替换为你的MySQL URL
                "root",                              // 替换为你的用户名
                "root"                               // 替换为你的密码
        );
        ...
        String querySkuSql = "select sku_info.id as skuid,      \n" +
                ...
                "from flink_realtime.sku_info              \n" +
                "join flink_realtime.spu_info              \n" +
                "on sku_info.spu_id = spu_info.id       \n" +
                "join flink_realtime.base_trademark        \n" +
                "on flink_realtime.spu_info.tm_id = flink_realtime.base_trademark.id";
